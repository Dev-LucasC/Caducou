...
1. Read `.agents/POLITICA_DE_TRABALHO.md` completely enough to apply product, architecture, security, LGPD, UX/UI, testing, and Codex-agent constraints.
2. Read the PRD completely — do NOT skip this step.
3. Identify technical content, constraints, and success metrics.
4. Extract core requirements for architectural consideration.
...
2. Map the solution against `.agents/POLITICA_DE_TRABALHO.md`, especially sensitive-data minimization, auditability, authorization, financial integrity, and SDD constraints.
...
## Quality Checklist
- [ ] PRD reviewed.
- [ ] Caducou working policy reviewed and mapped.
