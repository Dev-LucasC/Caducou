...
1. Read `.agents/POLITICA_DE_TRABALHO.md` and apply its SDD, LGPD, security, audit, UX/UI, architecture, testing, and human-review rules.
2. Read the task definition file at `./tasks/prd-[feature-slug]/[num]_task.md`.
3. Read the PRD at `./tasks/prd-[feature-slug]/prd.md` for context.
4. Read the Tech Spec at `./tasks/prd-[feature-slug]/techspec.md` for technical requirements.
...
1. Analyze the task considering:
   ...
   - Alignment with `.agents/POLITICA_DE_TRABALHO.md`.
...
2. Follow all project standards established in AGENTS.md and project rules.
3. Implement solutions without workarounds.
4. Stop and request human review before proceeding when the task involves payments, platform commission, sensitive personal data, permanent data deletion, collection automation, third-party integrations, legal rules, authentication/authorization changes, or structural database changes.
5. Create and run all task tests before considering the task finished.
