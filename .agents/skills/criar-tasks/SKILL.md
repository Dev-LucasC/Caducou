...
1. Read `.agents/POLITICA_DE_TRABALHO.md` and keep its Definition of Ready, Definition of Done, testing, LGPD, audit, and security rules visible while creating tasks.
2. Read the PRD completely to extract requirements.
3. Read the Tech Spec completely to extract technical decisions.
...
6. Tasks that touch payments, commissions, sensitive personal data, permanent deletion, collection automation, third-party integrations, legal rules, auth/authorization, or structural database changes MUST explicitly call out human review.
...
- [ ] Caducou working policy reviewed and reflected in the task plan.
