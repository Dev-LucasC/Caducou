...
3. Read `.agents/POLITICA_DE_TRABALHO.md` and apply its product, SDD, LGPD, security, UX/UI, and quality rules to the PRD.
...
- Always align with the Caducou working policy before drafting.

## Quality Checklist
- [ ] Clarification questions completed and answered.
- [ ] Caducou working policy reviewed and reflected.
